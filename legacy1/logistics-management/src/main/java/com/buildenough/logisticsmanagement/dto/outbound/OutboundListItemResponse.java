...
@Getter
public class OutboundListItemResponse {
    ...
    public OutboundListItemResponse(Outbound outbound) {
        ...
        this.itemCount = outbound.getItems().size();
        this.totalQuantity = outbound.getItems().stream()
